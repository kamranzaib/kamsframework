...
public class ExtentManager {
    ...
    public synchronized static ExtentReports getInstance(){
        if(extent == null){
            ...
            Reporter.log("Extent Report Direcotry" + resultDirectory, true );
            extent.addSystemInfo("Host Name", "PNT").addSystemInfo("Enviorment", "QA").addSystemInfo("User Name", "Kamran Zaib");
